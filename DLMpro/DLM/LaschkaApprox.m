function [I1, I2] = LaschkaApprox(u1,k1,dsp)
% LaschkaApprox calculates integrals I1 and I2 with Laschka
% Approximation
%% Description:
%   Laschka approximation is calculated in LaschkaApproxCalc(). This
...
if dsp
    ...
    disp(dt+" Start Laschka approximation...")
end
...
[I1_pos,I2_pos] = LaschkaApproxCalc(u1_t1,k1_t1);
...
[I1_0,I2_0] = LaschkaApproxCalc(u1_0,k1_t2);
[I1_neg,I2_neg] = LaschkaApproxCalc(u1_t2,k1_t2);
...
if dsp
    dt = datestr(now,'HH:MM:SS.FFF');
    disp(dt+" Laschka Approximation: Done")
end
